...
class _CupertinoSwitchState extends State<CustomSwitch> with TickerProviderStateMixin {
...
const double _kTrackHeight = 290.0;
const double _kTrackRadius = _kTrackWidth / 2.0;
const double _kTrackInnerStart = _kTrackHeight / 2.0;
const double _kTrackInnerEnd = _kTrackHeight - _kTrackInnerStart;
const double _kTrackInnerLength = _kTrackInnerEnd - _kTrackInnerStart;
const double _kSwitchWidth = 100.0;
const double _kSwitchHeight = 300.0;
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final Rect trackRect = Rect.fromLTWH(
      (offset.dx + (size.width - _kTrackWidth) / 2.0) + 10,
      (offset.dy + (size.height - _kTrackHeight) / 2.0) + 10,
      _kTrackWidth + 10,
      _kTrackHeight + 10,
    );
